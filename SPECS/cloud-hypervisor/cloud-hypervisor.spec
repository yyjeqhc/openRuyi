...
BuildRequires:  crate(crypto-common-0.2) >= 0.2.1
...
BuildRequires:  crate(jiff-0.2/alloc) >= 0.2.24
...
BuildRequires:  crate(toml-datetime-1/alloc) >= 1.1.1
BuildRequires:  crate(toml-datetime-1/default) >= 1.1.1
BuildRequires:  crate(toml-datetime-1/std) >= 1.1.1
BuildRequires:  crate(toml-edit-0.25) >= 0.25.12
BuildRequires:  crate(toml-edit-0.25/parse) >= 0.25.12
BuildRequires:  crate(toml-parser-1) >= 1.1.2
BuildRequires:  crate(toml-parser-1/alloc) >= 1.1.2
BuildRequires:  crate(toml-parser-1/default) >= 1.1.2
BuildRequires:  crate(toml-parser-1/std) >= 1.1.2
BuildRequires:  crate(typenum-1) >= 1.20.0
BuildRequires:  crate(typenum-1/const-generics) >= 1.20.0
