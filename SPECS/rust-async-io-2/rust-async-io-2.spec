...
Requires:       crate(parking-2.0/default) >= 2.0.0
Requires:       crate(polling-3.0/default) >= 3.4.0
Requires:       crate(rustix-1.0/fs) >= 1.0.7
Requires:       crate(rustix-1.0/net) >= 1.0.7
Requires:       crate(rustix-1.0/std) >= 1.0.7
