...
%global pkgname miniz-oxide-0.9

Name:           rust-miniz-oxide-0.9
Version:        0.9.1
Release:        %autorelease
...
Requires:       crate(adler2-2.0) >= 2.0.0
...
Requires:       crate(adler2-2.0/rustc-dep-of-std) >= 2.0.0
...
%package     -n %{name}+std
Summary:        DEFLATE compression and decompression library rewritten in Rust based on miniz - feature "std"
Requires:       crate(%{pkgname})
Requires:       crate(serde-1.0/alloc) >= 1.0.0
Requires:       crate(serde-1.0/derive) >= 1.0.0
...
This metapackage enables feature "std" for the Rust miniz_oxide crate, by pulling in any additional dependencies needed by that feature.
