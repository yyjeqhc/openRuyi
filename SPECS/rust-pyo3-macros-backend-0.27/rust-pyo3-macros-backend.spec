...
Requires:       crate(proc-macro2-1) >= 1.0.103
Requires:       crate(pyo3-build-config-0.27/default) >= 0.27.2
Requires:       crate(pyo3-build-config-0.27/resolve-config) >= 0.27.2
Requires:       crate(quote-1) >= 1.0.42
Requires:       crate(syn-2/clone-impls) >= 2.0.111
Requires:       crate(syn-2/derive) >= 2.0.111
Requires:       crate(syn-2/extra-traits) >= 2.0.111
Requires:       crate(syn-2/full) >= 2.0.111
Requires:       crate(syn-2/parsing) >= 2.0.111
Requires:       crate(syn-2/printing) >= 2.0.111
Requires:       crate(syn-2/visit-mut) >= 2.0.111
