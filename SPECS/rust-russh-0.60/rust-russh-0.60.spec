...
Requires:       crate(aead-0.6/default) >= 0.6.0
...
Requires:       crate(elliptic-curve-0.14.0-rc.34/default) >= 0.14.0-rc.34
Requires:       crate(elliptic-curve-0.14.0-rc.34/ecdh) >= 0.14.0-rc.34
...
Requires:       crate(ml-kem-0.3/default) >= 0.3.0
