...
#!RemoteAsset:  sha256:61f703d19852dbf87cbc513643fa81428361eb6940f1ac14fd58155d295a3eb0
...
%package     -n %{name}+ryu
Summary:        Decimal number implementation written in pure Rust suitable for financial and fixed-precision calculations - feature "ryu"
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(ryu-1) >= 1.0.0
Provides:       crate(%{pkgname}/ryu) = %{version}

%description -n %{name}+ryu
This metapackage enables feature "ryu" for the Rust rust_decimal crate, by pulling in any additional dependencies needed by that feature.
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(%{pkgname}/ryu) = %{version}
Requires:       crate(%{pkgname}/serde) = %{version}
