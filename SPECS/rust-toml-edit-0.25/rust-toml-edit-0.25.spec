...
Provides:       crate(%{pkgname}/unbounded) = %{full_version}
...
Requires:       crate(%{pkgname}/display) = %{full_version}
...
Requires:       crate(%{pkgname}) = %{full_version}
Requires:       crate(%{pkgname}/display) = %{full_version}
Requires:       crate(%{pkgname}/parse) = %{full_version}
...
Provides:       crate(%{pkgname}/display) = %{full_version}
...
Provides:       crate(%{pkgname}/parse) = %{full_version}
