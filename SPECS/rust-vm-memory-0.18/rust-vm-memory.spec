...
Requires:       crate(thiserror-2.0/default) >= 2.0.16
...
Requires:       crate(arc-swap-1.0/default) >= 1.0.0
...
Requires:       crate(%{pkgname})
Requires:       crate(rangemap-1.0/default) >= 1.5.1
Provides:       crate(%{pkgname}/iommu)
